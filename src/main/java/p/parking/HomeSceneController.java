...
//  из-за изменения размера окон просмотра изображений в архиве - требуется дороботка баг*
    ...
    public void initialize() throws IOException {
        ...
        imArh1.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop31.jpg")));
        imArh2.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop32.jpg")));
        imArh3.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop33.jpg")));
        imArh4.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop34.jpg")));
        imgV1.setImage(new Image(getClass().getResourceAsStream("photo/pop3.jpg")));
        imArh11.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop31.jpg")));
        imArh21.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop32.jpg")));
        imArh31.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop33.jpg")));
        imArh41.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop34.jpg")));
        imArh411.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop35.jpg")));
        imArh311.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop36.jpg")));
        imArh111.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop37.jpg")));
        imArh2111.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop38.jpg")));
        imArh211.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop39.jpg")));
        imArh1111.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop31.jpg")));
        imArh3111.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop32.jpg")));
        imArh4111.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop33.jpg")));
        imArh2112.setImage(new javafx.scene.image.Image(getClass().getResourceAsStream("photo/pop34.jpg")));
